...
export const testimonials: Testimonial[] = [
  {
    ...
    locationHi: "पंजाब, भारत",
    content: "Working with Mohan Krushi Udyog has transformed my farming business. They offer fair prices and their quality standards have helped me improve my crop quality significantly.",
    contentHi: "मोहन कृषि उद्योग के साथ काम करने से मेरे खेती के व्यवसाय में बदलाव आया है। वे उचित मूल्य देते हैं और उनके गुणवत्ता मानकों ने मेरी फसल की गुणवत्ता में काफी सुधार किया है।",
    rating: 5,
  },
  {
    id: 2,
    ...
    content: "The quality of grains from Mohan Krushi Udyog is exceptional. My family loves the freshness and purity. It's worth every penny for the health of my loved ones.",
    contentHi: "मोहन कृषि उद्योग से मिलने वाले अनाज की गुणवत्ता बेहतरीन है। मेरे परिवार को इसकी ताजगी और शुद्धता पसंद है। यह मेरे प्रियजनों के स्वास्थ्य के लिए हर पैसे के लायक है।",
    rating: 5,
  },
  {
    id: 3,
